...
//      userService.add(new User("User4", "Lastname4", "user4@mail.ru", new Car("Bentley",4)));
//      userService.add(new User("User5", "Lastname5", "user5@mail.ru", new Car("Lada Kalina",555)));

      User user = userService.getUserByCar("Lada Kalina", 555);
